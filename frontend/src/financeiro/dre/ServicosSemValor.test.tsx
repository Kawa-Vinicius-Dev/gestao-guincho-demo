...
test('poucos serviços sem valor aparecem um por um, e os que têm valor ficam de fora', async () => {
  ...
  render(<MemoryRouter><ServicosSemValor inicio="2026-09-01" fim="2026-09-15"/></MemoryRouter>)
...
test('sem serviço sem valor, o painel não aparece', async () => {
  ...
  const { container } = render(<MemoryRouter><ServicosSemValor inicio="2026-09-01" fim="2026-09-15"/></MemoryRouter>)
