...
import { corrigirOs, definirViaturaEmLote, informarValorManual, listarOs, listarTodasAsOs, TAMANHO_DA_PAGINA, type FiltroOs, type LinhaOs, type PaginaOs, type SituacaoOs } from '../dados/porto/listaOs'
  ...
  return <div className="page-enter">
    ...
    <Painel semRespiro>
      ...
      {dados && !dados.itens.length
        ...
        : dados ? <div className="table-scroll tabela-rolagem"><table className="tabela-os" aria-label="Ordens de serviço">
          <thead><tr>
