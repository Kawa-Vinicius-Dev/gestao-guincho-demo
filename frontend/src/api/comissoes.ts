...
import type { AlimentacaoComissao,CalendarioPorto,Comissao,DetalheSocorrista,PagamentoComissao,ResumoComissao } from '../types/modelos'
...
export const obterDetalheSocorrista=(motoristaId:number,calendarioPagamentoId:number)=>api<DetalheSocorrista>(`/api/equipe/${motoristaId}/detalhes?calendarioPagamentoId=${calendarioPagamentoId}`)
