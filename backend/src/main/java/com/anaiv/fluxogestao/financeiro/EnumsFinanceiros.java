...
public final class EnumsFinanceiros {
    ...
    public enum TipoRelatorioPorto { PREVISAO_RECEBER, SERVICOS_GERAIS, SERVICOS_AGUARDANDO_LANCAMENTO, OS_VINCULADAS, SERVICOS_DEVOLVIDOS, PAINEL_DIARIO }
    public enum StatusPendenciaPorto { ABERTA, RESOLVIDA }
    public enum StatusOperacionalPorto { NORMAL, AGUARDANDO_LANCAMENTO, PROCESSADO, LIBERADO_APOS_ANALISE, PENDENTE_PORTO, DEVOLVIDO_FINALIZADO, CANCELADO }
