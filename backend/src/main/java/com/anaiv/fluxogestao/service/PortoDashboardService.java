...
public class PortoDashboardService {
    ...
    @Transactional(readOnly=true) public Map<String,Object> dashboard(PortoDashboardFiltros filtro){
        ...
        PortoOsFiltros osFiltro=new PortoOsFiltros(inicio,fim,filtro.numeroOs(),numeroOp,filtro.especialidade(),filtro.socorrista(),filtro.qra(),filtro.viatura(),filtro.statusOperacional(),filtro.statusFinanceiro(),filtro.statusConciliacao(),porPagamento,null);
