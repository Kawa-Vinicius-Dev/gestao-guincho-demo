...
public class PortoService {
    ...
    private OrdemPagamentoResponse op(OrdemPagamentoPorto x){return new OrdemPagamentoResponse(x.getId(),x.getNumero(),x.getValorTotal(),x.getNomeCodigo(),x.getDataPagamentoProgramada(),x.getValorRecebido(),x.getDataRecebimento(),x.getDataRecebimento()==null?"PROGRAMADO":"RECEBIDO");}
