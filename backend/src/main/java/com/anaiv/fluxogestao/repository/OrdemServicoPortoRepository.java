...
public interface OrdemServicoPortoRepository extends JpaRepository<OrdemServicoPorto,Long>{Optional<OrdemServicoPorto> findByNumero(String numero);List<OrdemServicoPorto> findByNumeroIn(Collection<String> numeros);List<OrdemServicoPorto> findByOrdemPagamento(OrdemPagamentoPorto op);List<OrdemServicoPorto> findByImportacao(Importacao importacao);List<OrdemServicoPorto> findByMotorista(Motorista motorista);}
