...
public final class EnumsFinanceiros {
    ...
    public enum TipoRelatorioPorto { PREVISAO_RECEBER, SERVICOS_GERAIS, OS_VINCULADAS, SERVICOS_DEVOLVIDOS }
    public enum StatusPendenciaPorto { ABERTA, RESOLVIDA }
    public enum StatusOperacionalPorto { NORMAL, PENDENTE_PORTO, DEVOLVIDO_FINALIZADO }
    public enum StatusFinanceiroPorto { AGUARDANDO_OP, PAGAMENTO_PROGRAMADO, RECEBIDO, BLOQUEADO_PARA_PAGAMENTO, VALOR_DIVERGENTE }
