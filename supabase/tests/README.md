...
- `96_fixas_automaticas_e_categorias.sql` — asserções de que a despesa fixa entra
  sozinha, já paga, no vencimento (com parcela e sem duplicar), de que o socorrista
  só lança em categoria liberada e de que a comissão padrão é legível logado.
