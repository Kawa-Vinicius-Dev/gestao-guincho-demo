-- ===========================================================================
-- Aplicar agora: as tres migracoes pendentes, na ordem, numa colagem so.
--
-- Cole este arquivo inteiro no SQL Editor do Supabase e rode. E o mesmo
-- conteudo dos tres arquivos de migrations/, concatenado na ordem das datas:
--
--   20260916140000_despesas_do_socorrista_na_tela.sql
--   20260916150000_administrador_lanca_em_um_passo.sql
--   20260916160000_alimentacao_nunca_tem_viatura.sql
--
-- Rodar duas vezes nao faz mal: as tres sao create or replace / drop if
-- exists. Nenhuma apaga dado, nenhuma altera coluna, nenhuma mexe em linha
-- que ja existe.
-- ===========================================================================
